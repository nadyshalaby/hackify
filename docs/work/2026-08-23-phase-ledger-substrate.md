...
Every finding from the panel got one adversarial refuter before any fix was spent on it. Fourteen findings, four refuted, ten upheld and fixed. Refuted findings got no fix, and one fix that had already been applied to a since-refuted finding was reverted.
