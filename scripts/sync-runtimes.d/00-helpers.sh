...
MIRROR_SOURCES=(
  ...
  "skills/hackify/references/parallel-agents/phase-3-module-implementation.md"
  ...
  "skills/hackify/assets/report-template.html"
  "skills/hackify/assets/design-preview-template.html"
  "skills/hackify/scripts/render-report.py"
