...
three of those four mirrors carry a tail of ZERO lines, and the empty tail is a
...
wearing nine pass lines. Those pairs now print `none` and say what was actually
