...
[![Version](https://img.shields.io/badge/version-0.17.1-7c3aed.svg)](.claude-plugin/plugin.json)
...
agents/           9 sub-agent definitions, each mirroring a template under
