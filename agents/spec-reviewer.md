...
Phase 2.5 dispatches ONE agent. It replaced a three-agent and then a two-agent fan-out; the letters A, B and C are retired and never reassigned. Phase 5 has its own Reviewers A through F, a different panel in a different phase.
