...
Reflect → ask 1–2 forking questions → loop until the user signals build → distill → create the work-doc with a Groom Provenance block → hand off to hackify Phase 1.
