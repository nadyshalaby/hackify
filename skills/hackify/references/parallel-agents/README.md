...
| `phase-5-escalation.md` | Sub-agent prompt for one Phase 5 specialist escalation reviewer (lens pinned at dispatch — e.g. security, accessibility, infrastructure, data). | Phase 5 escalation when the diff touches a specialist surface beyond the baseline A/B/C/D reviewers. |
