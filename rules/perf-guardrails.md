...
The deterministic perf-scout (`skills/hackify/references/perf-scout.md`) greps for these at every Phase 3 wave-end and at Phase 5 start, and Reviewer D (performance) judges every staged candidate against the catalog — quick and yolo run the same checks at their mirror points.
